    ...
    return (
      <div className={classes.root}>
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          First, you will need to first click the 'BEGIN' button on the center section of the
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          ...
          the analyzing process. Each selection type will provide different visualizations
          when navigating to visual pages. In the 'Select Materials' tab,
        </Typography>
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          You will see a page listing all materials within the CS Materials database.
        </Typography>
        <img src={require('../../common/images/analyzetut_3.PNG')} alt="Italian Trulli" ></img>
        <Typography variant="body1" className={classes.body} gutterBottom>
          Each material has an associated check box that you can click to select a material.
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          ...
          non hit tags, and the root node respectively. Hovering over a tag will display all the materials assciated with it in the top right
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          ...
          This view allows the user to easily make classification edits to their material by click in cells
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          Hovering over a cell will highlight it and display the 'breadcrumbs' (path in ACM tree) to that tags
        ...
        <Typography variant="body1" className={classes.body} gutterBottom>
          ...
          is used to represent the number of materials assocciated with a given tag from each list. The darker the color purple or orange, the more that
          ...
          assciated with it in the top right with the percentage of coverage from each list
          and the path to the node from the root on the left.
        </Typography>
        <Typography variant="h4" className={classes.subHeading}>
